...
train ./configs mk1_pretrain.yaml "exp_name=mk1_pretrain model.train_mask_ratio=0.75"

# Step-2: Finetuning at 256x256 image resolution with no patch masking
train ./configs mk1_finetune.yaml "exp_name=mk1_finetune model.train_mask_ratio=0.0 trainer.load_path=./trained_models/mk1_pretrain/latest-rank0.pt"